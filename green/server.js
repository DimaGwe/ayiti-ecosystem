/**
 * Ayiti Green - Main Server
 * green.ayiti.com
 *
 * Recycling rewards platform where users earn credits by recycling waste
 * Track environmental impact and find collection points
...
app.use(session({
  secret: process.env.SESSION_SECRET || 'ayiti-green-secret-key-change-in-production',
  resave: false,
...
const PORT = process.env.GREEN_PORT || 3003;
...
║  - Log recycling by type & weight                 ║
║  - Find collection points nearby                  ║
